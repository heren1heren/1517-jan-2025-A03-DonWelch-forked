...
namespace WestWindSystem.BLL
{
    public class BuildVersionServices
    {
        ...
        //we will save this instance in a private variable usable throughout this service class
        ...
        {
            /*
            * this will use the context variable in BuildVersions to obtain the
            ...
            *      name of the entity
            *  the dataset created will contain 0, 1 or more records, one for
