...
public partial class Product
{
    ...
    //when the virtual declarations is a single class name, the relationship
    //  is considered to be a parent to the class
    [ForeignKey("CategoryID")]
    [InverseProperty("Products")]
    public virtual Category Category { get; set; }

    //when the virtual declarations is a collection (ICollection), the relationship
    //  is considered to be a child to the class
